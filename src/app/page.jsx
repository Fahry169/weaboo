...
const Page = async () => {
  const airingAnime = await getAnimeResponse("seasons/now", "limit=10&page=1");
  const newAnime = await getAnimeResponse("seasons/upcoming", "limit=10&page=1");
  const topAnime = await getAnimeResponse("top/anime", "limit=10&page=1");
