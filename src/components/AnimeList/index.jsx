                ...
                <div className="relative group">
                  <div className="relative aspect-[2/3] w-full">
                    ...
                    <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-95 transition-all duration-300 rounded px-3 py-5 flex flex-col gap-2">
                      ...
                      <button className="absolute right-0 bottom-0 px-4 py-2 m-2 rounded-xl text-base bg-color-1 text-white">
                        More
                      </button>

                    </div>
                  </div>
                  <h3 className="text-sm font-medium mt-2 line-clamp-3 text-color-1 group-hover:text-black transition-colors">
